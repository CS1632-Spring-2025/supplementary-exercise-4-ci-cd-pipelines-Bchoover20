...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    driver.manage().window().setSize(new Dimension(812, 873));
    driver.findElement(By.linkText("Reset")).click();
    vars.put("currentURL", js.executeScript("return window.location.href;"));
    System.out.println(vars.get("currentURL").toString());
    assertEquals(vars.get("currentURL").toString(), "https://localhost:8080/reset");
  }
  @Test
  ...
  public void tEST3CATALOG() {
    ...
    js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
    js.executeScript("document.cookie = \"1=true\";document.cookie = \"2=true\";document.cookie = \"3=true\";");
    driver.manage().window().setSize(new Dimension(812, 874));
    ...
    assertEquals(vars.get("image2").toString(), "https://localhost:8080/images/cat2.jpg");
  }
  @Test
  ...
  public void tEST7RETURN() {
    ...
    driver.manage().window().setSize(new Dimension(949, 750));
    driver.findElement(By.linkText("Rent-A-Cat")).click();
  ...
  public void tEST9FEED() {
    driver.get("https://localhost:8080/");
    js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
    driver.manage().window().setSize(new Dimension(887, 750));
    driver.findElement(By.linkText("Feed-A-Cat")).click();
  ...
  public void dEFECT3FUNFEED() {
    ...
    driver.findElement(By.linkText("Feed-A-Cat")).click();
    driver.findElement(By.id("catnips")).click();
    driver.findElement(By.id("catnips")).sendKeys("-20");
    driver.findElement(By.xpath("//button[contains(.,\'Feed\')]")).click();
